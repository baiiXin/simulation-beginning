...
def compute_edge_hessian(
    ...
    for tid in range(edge_collision_pairs.shape[0]//2):
        ...
        # force
        edge_force[e1_v1] = edge_force[e1_v1] + force * 0.5 * (1.0 - s)
        edge_force[e1_v2] = edge_force[e1_v2] + force * 0.5 * s
        edge_force[e2_v1] = edge_force[e2_v1] -force * 0.5 * (1.0 - t)
        edge_force[e2_v2] = edge_force[e2_v2] -force * 0.5 * t

        # hessian
        # e1
        edge_hessian[e1_v1, e1_v1] = edge_hessian[e1_v1, e1_v1] + hessian * 0.5 * (1.0 - s) * (1.0 - s)
        edge_hessian[e1_v2, e1_v2] = edge_hessian[e1_v2, e1_v2] + hessian * 0.5 * s * s
        edge_hessian[e1_v1, e1_v2] = edge_hessian[e1_v1, e1_v2] + hessian * 0.5 * (1.0 - s) * s
        edge_hessian[e1_v2, e1_v1] = edge_hessian[e1_v2, e1_v1] + hessian * 0.5 * s * (1.0 - s)
        # e2
        edge_hessian[e2_v1, e2_v1] = edge_hessian[e2_v1, e2_v1] + hessian * 0.5 * (1.0 - t) * (1.0 - t)
        edge_hessian[e2_v2, e2_v2] = edge_hessian[e2_v2, e2_v2] + hessian * 0.5 * t * t
        edge_hessian[e2_v1, e2_v2] = edge_hessian[e2_v1, e2_v2] + hessian * 0.5 * (1.0 - t) * t
        edge_hessian[e2_v2, e2_v1] = edge_hessian[e2_v2, e2_v1] + hessian * 0.5 * t * (1.0 - t)
        # e1-e2
        edge_hessian[e1_v1, e2_v1] = edge_hessian[e1_v1, e2_v1] - hessian * 0.5 * (1.0 - s) * (1.0 - t)
        edge_hessian[e1_v1, e2_v2] = edge_hessian[e1_v1, e2_v2] - hessian * 0.5 * (1.0 - s) * t
        edge_hessian[e1_v2, e2_v1] = edge_hessian[e1_v2, e2_v1] - hessian * 0.5 * s * (1.0 - t)
        edge_hessian[e1_v2, e2_v2] = edge_hessian[e1_v2, e2_v2] - hessian * 0.5 * s * t
        # e2-e1
        edge_hessian[e2_v1, e1_v1] = edge_hessian[e2_v1, e1_v1] - hessian * 0.5 * (1.0 - t) * (1.0 - s)
        edge_hessian[e2_v1, e1_v2] = edge_hessian[e2_v1, e1_v2] - hessian * 0.5 * (1.0 - t) * s
        edge_hessian[e2_v2, e1_v1] = edge_hessian[e2_v2, e1_v1] - hessian * 0.5 * t * (1.0 - s)
        edge_hessian[e2_v2, e1_v2] = edge_hessian[e2_v2, e1_v2] - hessian * 0.5 * t * s 
